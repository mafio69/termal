<div class="table-responsive table-striped table-hover" style="overflow: visible;">
    <table class="table footable table-striped table-hover" >
        <tr><th>Firma</th><th data-breakpoints="xs sm md" >Status</th><th data-breakpoints="xs sm">Miasto</th><th data-breakpoints="xs" >Telefon</th><th data-breakpoints="xs sm" >Email</th><th data-breakpoints="xs sm">WWW</th><th data-breakpoints="xs" >Akcja</th></tr>
                    ...
                    <td>
                        <div class="dropdown ">
                            ...
                            <ul class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenu1">
                                <li><a href="{{url('/projekt/'.$customer->id.'/create')}}" title="Dodaj projekt"><i class="fa fa-plus" aria-hidden="true"></i> Dodaj projekt</a></li>
